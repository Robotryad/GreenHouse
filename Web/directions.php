...
<html lang="ru">
	...
	<body >
        <head class="head">Ваша теплица</head>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="manual-control.php">Ручное управление</a></li>
        ...
        <main class="content">Умная теплица обеспечит строгий контроль за вашими растениями, а с помощью интернета вы сможете удалённо ей управлять.В случае проблем можно посмотреть в <a href="directory.php">справочник</a>.
        </main>
        <footer class="footer">
